...
<style scoped>
  ...
  header {
    border-bottom: 4px solid #C5E6F9;
    ...
    top: 0;
    z-index: 10;
    overflow-x: auto; /* Changed to horizontal scrolling */
    overflow-y: hidden; /* Prevent vertical scrolling */
    width: 100%;
    background-color: #C5E6F9; /* Ensure background matches the body */
  }
  ...
  a:active {
    color: #1E63A6; /* Stronger contrast for active links */
    text-decoration: underline;
  }

  .outer-icon {
    background-color: white;
    border-radius: 50%; /* Cleaner circular shape */
    width: 34px;
    height: 34px;
    box-sizing: border-box;
    display: flex;
  ...
  .outer-box {
    ...
    padding: 4px;
    border-radius: 50%; /* Ensures consistent circular borders */
  }
